...
func TestDockerRunArgumentsArePinnedAndContainNoToken(t *testing.T) {
	...
	for _, expected := range []string{"create", "--read-only", "gh-gateway-a13f20-certs:/certs:ro", "127.0.0.1:443:443", "127.0.0.1:22:22", "GATEWAY_UPSTREAM_IP=10.0.0.20", "io.gh-gateway.managed=true", "local:test serve"} {
